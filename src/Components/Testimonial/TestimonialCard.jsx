    ...
    <>
      <div className="card testimonial_card">
        <div className="card-body px-4 py-4 py-md-5">
          ...
          <p className="pt-2 pt-md-4 testimonial_description">Dialect is excellent - short and sweet and effective lessons and great quick review which is key to remembering. I love it! I’m learning Dutch!! I enjoy the dialogues and scenarios, which include helpful phrases that can be used in various situations.</p>
          <div className="d-flex align-items-center">
